...
function Modal({ isOpen, onClose, children }) {
  ...
  return (
    ...
    >
      <div
        className="bg-[#121212] border border-yellow-400 rounded-xl shadow-2xl max-w-5xl w-[90%] lg:w-[70%] p-8 relative flex flex-col lg:flex-row gap-6 animate-fadeIn"
      ...
      >
        ...
        <div className="lg:w-1/2 text-gray-300 overflow-y-auto max-h-[70vh] pr-4">
          ...
          >
            📄 Rules and Guidelines for CTF Challenge
          </a>
        </div>
